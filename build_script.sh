...
# Step 0: Install system dependencies for pygame (SDL2)
...
npm ci  # faster & reproducible installs using package-lock.json
npm run build

# Step 2: Move built frontend to Flask backend
